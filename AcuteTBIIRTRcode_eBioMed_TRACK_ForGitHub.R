...
#Open the TRACK-TBI data
dat <- read.csv("dataset_1168_1773155061.csv")
...
sum(is.na(dat$GCSEDArrVerbal_R))/length(dat$GCSEDArrVerbal_R)
...
# Variables for the IRT model - include Age and Sex for DIF testing

dat$AgeTri <- ifelse(dat$Age < 30, 0,
                     ifelse(dat$Age >= 30 & dat$Age < 50, 1, 2))
dat$AgeTri <- factor(dat$AgeTri, levels = c(0, 1, 2), labels = c("Under 30", "30 to 49", "50+"))

allvar <- c("Subject_ID",  "AgeTri", "Sex", "CT_SkullFx_R", "CT_Contusion_R", "CT_Shear_R", "CT_ExtraaxHematoma_R", "CT_EDH_R", "CT_SDH_R",
...
allvar.uni <- mirt(allvardata[ , 4:27], itemtype = c(rep("graded", 24)), model = 1, SE = T)

coef(allvar.uni, IRTpars = T, simplify = T)

## START OF DIF TESTING FOR AGE AND SEX - FULL MODEL ONLY

# Sex DIF

SexGroupMod <- multipleGroup(allvardata[ , 4:27], 1, allvardata$Sex, SE = TRUE)
coef(SexGroupMod, IRTpars = T, simplify = T)

DIF(SexGroupMod, which.par = c("a1"), Wald = T, p.adjust = "BH")

DIF(SexGroupMod, which.par = c("d"), Wald = T, p.adjust = "BH", items2test = 1)
DIF(SexGroupMod, which.par = c("d"), Wald = T, p.adjust = "BH", items2test = 2)
DIF(SexGroupMod, which.par = c("d"), Wald = T, p.adjust = "BH", items2test = 3)
DIF(SexGroupMod, which.par = c("d"), Wald = T, p.adjust = "BH", items2test = 4)
DIF(SexGroupMod, which.par = c("d"), Wald = T, p.adjust = "BH", items2test = 5)
DIF(SexGroupMod, which.par = c("d"), Wald = T, p.adjust = "BH", items2test = 6)
DIF(SexGroupMod, which.par = c("d"), Wald = T, p.adjust = "BH", items2test = 7)
DIF(SexGroupMod, which.par = c("d"), Wald = T, p.adjust = "BH", items2test = 8)
DIF(SexGroupMod, which.par = c("d"), Wald = T, p.adjust = "BH", items2test = 9)
DIF(SexGroupMod, which.par = c("d"), Wald = T, p.adjust = "BH", items2test = 10)
DIF(SexGroupMod, which.par = c("d"), Wald = T, p.adjust = "BH", items2test = 11)
DIF(SexGroupMod, which.par = c("d"), Wald = T, p.adjust = "BH", items2test = 12)
DIF(SexGroupMod, which.par = c("d"), Wald = T, p.adjust = "BH", items2test = 13)
DIF(SexGroupMod, which.par = c("d1", "d2", "d3", "d4", "d5", "d6"), Wald = T, p.adjust = "BH", items2test = 14)
DIF(SexGroupMod, which.par = c("d1", "d2", "d3", "d4", "d5", "d6"), Wald = T, p.adjust = "BH", items2test = 15)
DIF(SexGroupMod, which.par = c("d1", "d2", "d3", "d4"), Wald = T, p.adjust = "BH", items2test = 16)
DIF(SexGroupMod, which.par = c("d1", "d2", "d3", "d4", "d5"), Wald = T, p.adjust = "BH", items2test = 17)
DIF(SexGroupMod, which.par = c("d1", "d2", "d3"), Wald = T, p.adjust = "BH", items2test = 18)
DIF(SexGroupMod, which.par = c("d1", "d2", "d3", "d4", "d5", "d6", "d7", "d8", "d9"), Wald = T, p.adjust = "BH", items2test = 19)
DIF(SexGroupMod, which.par = c("d1", "d2", "d3", "d4", "d5", "d6", "d7", "d8", "d9"), Wald = T, p.adjust = "BH", items2test = 20)
DIF(SexGroupMod, which.par = c("d1", "d2", "d3", "d4", "d5", "d6", "d7", "d8", "d9"), Wald = T, p.adjust = "BH", items2test = 21)
DIF(SexGroupMod, which.par = c("d1", "d2", "d3", "d4", "d5", "d6", "d7", "d8", "d9"), Wald = T, p.adjust = "BH", items2test = 22)
DIF(SexGroupMod, which.par = c("d1", "d2", "d3", "d4", "d5", "d6", "d7", "d8", "d9"), Wald = T, p.adjust = "BH", items2test = 23)
DIF(SexGroupMod, which.par = c("d1", "d2"), Wald = T, p.adjust = "BH", items2test = 24)

itemnames <- colnames(allvardata[ , 4:27])
DIFAccount <- multipleGroup(allvardata[ , 4:27], 1, allvardata$Sex, SE = TRUE,
                            invariance = c(itemnames[c(4, 6, 9, 10, 11, 12, 13, 17, 22, 24)],
                                           'slopes', 'free_means', 'free_var'))

coef(DIFAccount, IRTpars = T, simplify = T)

# Re-check for DIF

DIF(DIFAccount, c('d'), items2test = 1, Wald = T)
DIF(DIFAccount, c('d'), items2test = 2, Wald = T)
DIF(DIFAccount, c('d'), items2test = 3, Wald = T)
#DIF(DIFAccount, c('d'), items2test = 4, Wald = T)
DIF(DIFAccount, c('d'), items2test = 5, Wald = T)
#DIF(DIFAccount, c('d'), items2test = 6, Wald = T)
DIF(DIFAccount, c('d'), items2test = 7, Wald = T)
DIF(DIFAccount, c('d'), items2test = 8, Wald = T)
#DIF(DIFAccount, c('d'), items2test = 9, Wald = T)
#DIF(DIFAccount, c('d'), items2test = 10, Wald = T)
#DIF(DIFAccount, c('d'), items2test = 11, Wald = T)
#DIF(DIFAccount, c('d'), items2test = 12, Wald = T)
#DIF(DIFAccount, c('d'), items2test = 13, Wald = T)

DIF(DIFAccount, which.par = c("d1", "d2", "d3", "d4", "d5", "d6"), Wald = T, p.adjust = "BH", items2test = 14)
DIF(DIFAccount, which.par = c("d1", "d2", "d3", "d4", "d5", "d6"), Wald = T, p.adjust = "BH", items2test = 15)
DIF(DIFAccount, which.par = c("d1", "d2", "d3", "d4"), Wald = T, p.adjust = "BH", items2test = 16)
#DIF(DIFAccount, which.par = c("d1", "d2", "d3", "d4", "d5"), Wald = T, p.adjust = "BH", items2test = 17)
DIF(DIFAccount, which.par = c("d1", "d2", "d3"), Wald = T, p.adjust = "BH", items2test = 18)
DIF(DIFAccount, which.par = c("d1", "d2", "d3", "d4", "d5", "d6", "d7", "d8", "d9"), Wald = T, p.adjust = "BH", items2test = 19)
DIF(DIFAccount, which.par = c("d1", "d2", "d3", "d4", "d5", "d6", "d7", "d8", "d9"), Wald = T, p.adjust = "BH", items2test = 20)
DIF(DIFAccount, which.par = c("d1", "d2", "d3", "d4", "d5", "d6", "d7", "d8", "d9"), Wald = T, p.adjust = "BH", items2test = 21)
#DIF(DIFAccount, which.par = c("d1", "d2", "d3", "d4", "d5", "d6", "d7", "d8", "d9"), Wald = T, p.adjust = "BH", items2test = 22)
DIF(DIFAccount, which.par = c("d1", "d2", "d3", "d4", "d5", "d6", "d7", "d8", "d9"), Wald = T, p.adjust = "BH", items2test = 23)
DIF(SexGroupMod, which.par = c("d1", "d2"), Wald = T, p.adjust = "BH", items2test = 24)

itemnames <- colnames(allvardata[ , 4:27])
DIFAccount <- multipleGroup(allvardata[ , 4:27], 1, allvardata$Sex, SE = TRUE,
                            invariance = c(itemnames[c(4, 6, 7, 8, 9, 10, 11, 12, 13, 16, 17, 18, 20, 21, 22, 24)],
                                           'slopes', 'free_means', 'free_var'))
...
#DIF(DIFAccount, which.par = c("d1", "d2", "d3", "d4", "d5", "d6", "d7", "d8", "d9"), Wald = T, p.adjust = "BH", items2test = 22)
DIF(DIFAccount, which.par = c("d1", "d2", "d3", "d4", "d5", "d6", "d7", "d8", "d9"), Wald = T, p.adjust = "BH", items2test = 23)
#DIF(DIFAccount, which.par = c("d1", "d2"), Wald = T, p.adjust = "BH", items2test = 24)

itemnames <- colnames(allvardata[ , 4:27])
DIFAccount <- multipleGroup(allvardata[ , 4:27], 1, allvardata$Sex, SE = TRUE,
                            invariance = c(itemnames[c(2, 4, 6, 7, 8, 9, 10, 11, 12, 13, 16, 17, 18, 19, 20, 21, 22, 24)],
                                           'free_means', 'free_var'))
...
plot(DIFAccount, xlim = c(-3, 3))

# Estimate latent mean difference assuming no DIF

NoSexDIFMod <- multipleGroup(allvardata[ , 4:27], 1, allvardata$Sex, SE = TRUE,
                             invariance = c('intercepts', 'slopes', 'free_means', 'free_var'))

coef(NoSexDIFMod, IRTpars = T, simplify = T)


## Age

AgeGroupMod <- multipleGroup(allvardata[ , 4:27], 1, allvardata$AgeTri, SE = TRUE,
                             technical = list(NCYCLES = 2000))
coef(AgeGroupMod, IRTpars = T, simplify = T)

DIF(AgeGroupMod, which.par = c("a1"), Wald = T, p.adjust = "BH")

DIF(AgeGroupMod, which.par = c("d"), Wald = T, p.adjust = "BH", items2test = 1)
DIF(AgeGroupMod, which.par = c("d"), Wald = T, p.adjust = "BH", items2test = 2)
DIF(AgeGroupMod, which.par = c("d"), Wald = T, p.adjust = "BH", items2test = 3)
DIF(AgeGroupMod, which.par = c("d"), Wald = T, p.adjust = "BH", items2test = 4)
DIF(AgeGroupMod, which.par = c("d"), Wald = T, p.adjust = "BH", items2test = 5)
DIF(AgeGroupMod, which.par = c("d"), Wald = T, p.adjust = "BH", items2test = 6)
DIF(AgeGroupMod, which.par = c("d"), Wald = T, p.adjust = "BH", items2test = 7)
DIF(AgeGroupMod, which.par = c("d"), Wald = T, p.adjust = "BH", items2test = 8)
DIF(AgeGroupMod, which.par = c("d"), Wald = T, p.adjust = "BH", items2test = 9)
DIF(AgeGroupMod, which.par = c("d"), Wald = T, p.adjust = "BH", items2test = 10)
DIF(AgeGroupMod, which.par = c("d"), Wald = T, p.adjust = "BH", items2test = 11)
DIF(AgeGroupMod, which.par = c("d"), Wald = T, p.adjust = "BH", items2test = 12)
DIF(AgeGroupMod, which.par = c("d"), Wald = T, p.adjust = "BH", items2test = 13)
DIF(AgeGroupMod, which.par = c("d1", "d2", "d3", "d4", "d5", "d6"), Wald = T, p.adjust = "BH", items2test = 14)
DIF(AgeGroupMod, which.par = c("d1", "d2", "d3", "d4", "d5", "d6"), Wald = T, p.adjust = "BH", items2test = 15)
DIF(AgeGroupMod, which.par = c("d1", "d2", "d3", "d4"), Wald = T, p.adjust = "BH", items2test = 16)
DIF(AgeGroupMod, which.par = c("d1", "d2", "d3", "d4", "d5"), Wald = T, p.adjust = "BH", items2test = 17)
DIF(AgeGroupMod, which.par = c("d1", "d2", "d3"), Wald = T, p.adjust = "BH", items2test = 18)
DIF(AgeGroupMod, which.par = c("d1", "d2", "d3", "d4", "d5", "d6", "d7", "d8", "d9"), Wald = T, p.adjust = "BH", items2test = 19)
DIF(AgeGroupMod, which.par = c("d1", "d2", "d3", "d4", "d5", "d6", "d7", "d8", "d9"), Wald = T, p.adjust = "BH", items2test = 20)
DIF(AgeGroupMod, which.par = c("d1", "d2", "d3", "d4", "d5", "d6", "d7", "d8", "d9"), Wald = T, p.adjust = "BH", items2test = 21)
DIF(AgeGroupMod, which.par = c("d1", "d2", "d3", "d4", "d5", "d6", "d7", "d8", "d9"), Wald = T, p.adjust = "BH", items2test = 22)
DIF(AgeGroupMod, which.par = c("d1", "d2", "d3", "d4", "d5", "d6", "d7", "d8", "d9"), Wald = T, p.adjust = "BH", items2test = 23)
DIF(AgeGroupMod, which.par = c("d1", "d2"), Wald = T, p.adjust = "BH", items2test = 24)


itemnames <- colnames(allvardata[ , 4:27])
DIFAccount <- multipleGroup(allvardata[ , 4:27], 1, allvardata$AgeTri, SE = TRUE,
                            invariance = c(itemnames[c(1, 4, 9, 10, 11, 12, 13, 16, 17, 18, 22, 24)],
                                           'free_means', 'free_var'))

# Re-check for DIF

#DIF(DIFAccount, c('a1'), items2test = 1, Wald = T) # No slope DIF
#DIF(DIFAccount, c('a1'), items2test = 2, Wald = T) # No slope DIF
DIF(DIFAccount, c('a1'), items2test = 3, Wald = T) # Slope DIF
#DIF(DIFAccount, c('a1'), items2test = 4, Wald = T)
#DIF(DIFAccount, c('a1'), items2test = 5, Wald = T) # No slope DIF
DIF(DIFAccount, c('a1'), items2test = 6, Wald = T) # Slope DIF
#DIF(DIFAccount, c('a1'), items2test = 7, Wald = T)
#DIF(DIFAccount, c('a1'), items2test = 8, Wald = T)
#DIF(DIFAccount, c('a1'), items2test = 9, Wald = T)
#DIF(DIFAccount, c('a1'), items2test = 10, Wald = T)
#DIF(DIFAccount, c('a1'), items2test = 11, Wald = T)
#DIF(DIFAccount, c('a1'), items2test = 12, Wald = T)
#DIF(DIFAccount, c('a1'), items2test = 13, Wald = T)

#DIF(DIFAccount, which.par = c('a1'), Wald = T, p.adjust = "BH", items2test = 14)
DIF(DIFAccount, which.par = c('a1'), Wald = T, p.adjust = "BH", items2test = 15) # Slope DIF
#DIF(DIFAccount, which.par = c('a1'), Wald = T, p.adjust = "BH", items2test = 16)
#DIF(DIFAccount, which.par = c('a1'), Wald = T, p.adjust = "BH", items2test = 17)
#DIF(DIFAccount, which.par = c('a1'), Wald = T, p.adjust = "BH", items2test = 18)
#DIF(DIFAccount, which.par = c('a1'), Wald = T, p.adjust = "BH", items2test = 19)
DIF(DIFAccount, which.par = c('a1'), Wald = T, p.adjust = "BH", items2test = 20) # Slope DIF
DIF(DIFAccount, which.par = c('a1'), Wald = T, p.adjust = "BH", items2test = 21) # Slope DIF
#DIF(DIFAccount, which.par = c('a1'), Wald = T, p.adjust = "BH", items2test = 22)
#DIF(DIFAccount, which.par = c('a1'), Wald = T, p.adjust = "BH", items2test = 23) # No slope DIF
#DIF(DIFAccount, which.par = c('a1'), Wald = T, p.adjust = "BH", items2test = 24)

# Slope DIF: 3, 6, 15, 20, 21
...
## END OF DIF TESTING FOR AGE AND SEX - FULL MODEL ONLY

# Variables and IRT model without biomarkers
...
no.biomarkers.uni <- mirt(allvar_nobiomarkers[ , 2:20], itemtype = c(rep("graded", 19)), model = 1, SE = T)
...
InfoData <- cbind(Theta, HeadCT, Clinical.All, Biomarkers)
InfoData <- data.frame(InfoData)
names(InfoData) <- c("Theta", "Head CT", "Clinical", "Biomarkers")
...
ggplot(data = InfoDataLong, aes(x = Theta, y = Information, color = Domain)) +
...
InfoData <- cbind(Theta, HeadCT, Clinical.All, Biomarkers, Test)
InfoData <- data.frame(InfoData)
names(InfoData) <- c("Theta", "Head CT", "Clinical-All", "Biomarkers", "Test")
...
TestGCSLOCPupil <- Clinical.GCS + Clinical.PTA.LOC.Pupil
TestGCSLOCPupilCT <- Clinical.GCS + Clinical.PTA.LOC.Pupil + HeadCT 
TestGCSLOCPupilCTBio <- Clinical.GCS + Clinical.PTA.LOC.Pupil + HeadCT + Biomarkers

SE.TestGCS <- 1/sqrt(TestGCS)
SE.TestGCSLOCPupil <- 1/sqrt(TestGCSLOCPupil)
SE.TestGCSLOCPupilCT <- 1/sqrt(TestGCSLOCPupilCT)
SE.TestGCSLOCPupilCTBio <- 1/sqrt(TestGCSLOCPupilCTBio)

InfoDataIncremental <- cbind(Theta, TestGCS, TestGCSLOCPupil, TestGCSLOCPupilCT, TestGCSLOCPupilCTBio)
InfoDataIncremental <- data.frame(InfoDataIncremental)
names(InfoDataIncremental) <- c("Theta", "GCS", "GCS + LOC/PTA/Pupil", "GCS + LOC/PTA/Pupil + CT", "GCS + LOC/PTA/Pupil + CT + Bio")
InfoDataIncremental <- melt(InfoDataIncremental, id.vars=c("Theta"))
names(InfoDataIncremental) <- c("Theta", "Domain", "Information")

SEDataIncremental <- cbind(Theta, SE.TestGCS, SE.TestGCSLOCPupil, SE.TestGCSLOCPupilCT, SE.TestGCSLOCPupilCTBio)
SEDataIncremental <- data.frame(SEDataIncremental)
names(SEDataIncremental) <- c("Theta", "GCS", "GCS + LOC/PTA/Pupil", "GCS + LOC/PTA/Pupil + CT", "GCS + LOC/PTA/Pupil + CT + Bio")
...
#Rank Regressions - prepared for a cover letter as part of peer review
...
##Prediction of missingness on each variable from others in model START.
#This was mostly for a cover letter response during peer review

# MODEL Make outcome = missingness of LOCDuration_R
dat$miss_LOCDuration <- as.integer(is.na(dat$LOCDuration_R))

# Subset to the 24 variables of interest
vars <- c(
  "CT_SkullFx_R",
  "CT_Contusion_R",
  "CT_Shear_R",
...
# Keep only complete cases on predictors
dat_sub <- dat[, c(vars, "miss_LOCDuration")]
dat_sub <- dat_sub[complete.cases(dat_sub), ]

# Build full logistic model
fmla <- as.formula(paste("miss_LOCDuration ~", paste(vars, collapse = " + ")))
fit_full <- glm(fmla, data = dat_sub, family = binomial)

# Run backward elimination
fit_step <- step(fit_full, direction = "backward")

summary(fit_step)
anova(fit_step, test = "Chisq")


# MODEL Make outcome = missingness of PTADuration_R
dat$miss_PTADuration <- as.integer(is.na(dat$LOCPTADuration_R))
...
# Keep only complete cases on predictors
dat_sub <- dat[, c(vars, "miss_PTADuration")]
dat_sub <- dat_sub[complete.cases(dat_sub), ]

# Build full logistic model
fmla <- as.formula(paste("miss_PTADuration ~", paste(vars, collapse = " + ")))
fit_full <- glm(fmla, data = dat_sub, family = binomial)
...
# MODEL Make outcome = missingness of GCS verbal
dat$miss_GCSVerb <- as.integer(is.na(dat$GCSEDArrVerbal_R))
...
# Keep only complete cases on predictors
dat_sub <- dat[, c(vars, "miss_GCSVerb")]
dat_sub <- dat_sub[complete.cases(dat_sub), ]

# Build full logistic model
fmla <- as.formula(paste("miss_GCSVerb ~", paste(vars, collapse = " + ")))
fit_full <- glm(fmla, data = dat_sub, family = binomial)
...
# CHECK LITTLE'S MCAR on subsets of variables. 
install.packages("naniar")
library(naniar)

# Subset the dataset, run Little's MCAR test, and review result
vars_ct <- c(
  "CT_SkullFx_R",
  "CT_Contusion_R",
  "CT_Shear_R",
...
dat_ct <- dat[vars_ct]
mcar_result_ct <- mcar_test(dat_ct)
...
dat_gcs <- dat[vars_gcs]
mcar_result_gcs <- mcar_test(dat_gcs)

vars_locpta <- c(
  "LOCDuration_R", 
  "LOCPTADuration_R"
)
dat_locpta <- dat[vars_locpta]
mcar_result_locpta <- mcar_test(dat_locpta)

vars_pupils <- c(
  "NumberNonreactingPupils" 
)
dat_pupils <- dat[vars_pupils]
mcar_result_pupils <- mcar_test(dat_pupils)

vars_gfapuch <- c(
  "gfap_cat",
  "uchl_cat" 
)
dat_gfapuch <- dat[vars_gfapuch]
mcar_result_gfapuch <- mcar_test(dat_gfapuch)
...
dat_otherbio <- dat[vars_otherbio]
mcar_result_otherbio <- mcar_test(dat_otherbio)
...
mcar_result_pupils
mcar_result_gfapuch
mcar_result_otherbio
#p = .071 for Little's test CT variables

#Predict CT missingness from other variables
vars <- c(
  "CT_SkullFx_R",
  "CT_Contusion_R",
  "CT_Shear_R",
...
dat_sub$CompleteDataCT <- ifelse(complete.cases(dat_sub[, c(
  "CT_SkullFx_R",
  "CT_Contusion_R",
  "CT_Shear_R",
  "CT_ExtraaxHematoma_R",
...
#Univariable models 
ModelMissingCT <- glm(
  CompleteDataCT ~ GCSEDArrVerbal_R,
  data = dat_sub,
...
summary(ModelMissingCT)
anova(ModModelMissingCT,test = "Chisq")
ModelMissingCT<- glm(
  CompleteDataCT ~ 
    nse_cat,
  data = dat_sub,
...
##Review patterns of missingness on the IRT model indicators
install.packages("naniar", type="binary")
install.packages("UpSetR", type="binary")
library(naniar)
library(UpSetR)
#Create variables with only the 24 indicators from the IRT model
dat24var <- c("CT_SkullFx_R", "CT_Contusion_R", "CT_Shear_R", "CT_ExtraaxHematoma_R", "CT_EDH_R", "CT_SDH_R",
            "CT_SAH_R", "CT_IVH_R", "CT_Edema_R", "CT_DownwardHerniation_R", "CT_UpwardCerebellarHerniation_R",
            "CT_DuretHemorrhage_R", "CT_MidlineShift_R", "LOCDuration_R", "LOCPTADuration_R", 
            "GCSEDArrVerbal_R", "GCSEDArrMotor_R", "GCSEDArrEyes_R",
            "gfap_cat", "uchl_cat", "nse_cat", "s100_cat", "crp_cat","NumberNonreactingPupils")
dat24var <- dat[dat24var] # Create dataset with just IRT variables
#Print Upset of missingness patterns
gg_miss_upset(dat24var)

print(gg_miss_upset(dat24var))

# dat24var already defined as in your code
miss_df <- as.data.frame(is.na(dat24var))  # logical TRUE = missing

# ComplexUpset expects boolean set-membership columns
ComplexUpset::upset(
  miss_df,
  sets = colnames(miss_df),
  name = "Missing",
  min_size = 1
)
